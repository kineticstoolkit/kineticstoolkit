...
def test_is_frame_point_vector_series():
    """Test private methods _is_frame_series etc."""
...
#     p.connect(["*SHO", "*ELB", "*WRA", "*WRB", "*ELB"], color="g")
#     assert (
#         str(p.get_interconnections())
...
#     # Check that adding a new connect in same group keeps current color
#     p.connect(["Derrick:LSHO", "Derrick:RSHO"], group="UpperBody")
#     assert (
#         str(p.get_interconnections())
...
#     )
#     p.disconnect(["Derrick:LSHO", "Derrick:RSHO"])
...
#     p.disconnect(group="ForcePlatforms")
#     assert (
#         str(p.get_interconnections())
...
def test_scripting():
    ...
    try:
        ...
        assert p._extended_interconnections["Derrick:TrunkPelvis"][
            ...
            ["Derrick:CLAV", "Derrick:STRN"],
            ["Derrick:LPSI", "Derrick:T10"],
            ["Derrick:RPSI", "Derrick:T10"],
            ["Derrick:C7", "Derrick:T10"],
            ["Derrick:LASI", "Derrick:LSHO"],
            ["Derrick:LPSI", "Derrick:LSHO"],
            ["Derrick:RASI", "Derrick:RSHO"],
            ["Derrick:RPSI", "Derrick:RSHO"],
            ["Derrick:LASI", "Derrick:LPSI"],
            ["Derrick:LASI", "Derrick:RASI"],
            ["Derrick:RASI", "Derrick:RPSI"],
        ...
        assert p._extended_interconnections["Viktor:LLowerLimb"]["Links"] == [
            ["Viktor:LHEE", "Viktor:LTOE"],
            ["Viktor:LANK", "Viktor:LHEE"],
            ["Viktor:LANK", "Viktor:LTOE"],
            ["Viktor:LANK", "Viktor:LKNE"],
            ["Viktor:LASI", "Viktor:LKNE"],
            ["Viktor:LKNE", "Viktor:LPSI"],
        ]
        assert p._extended_interconnections["Viktor:RLowerLimb"]["Links"] == [
            ["Viktor:RHEE", "Viktor:RTOE"],
            ["Viktor:RANK", "Viktor:RHEE"],
            ["Viktor:RANK", "Viktor:RTOE"],
            ["Viktor:RANK", "Viktor:RKNE"],
            ["Viktor:RASI", "Viktor:RKNE"],
            ["Viktor:RKNE", "Viktor:RPSI"],
        ]
        assert p._extended_interconnections["Viktor:LUpperLimb"]["Links"] == [
            ["Viktor:LELB", "Viktor:LSHO"],
            ["Viktor:LELB", "Viktor:LWRA"],
            ["Viktor:LFIN", "Viktor:LWRA"],
            ["Viktor:LELB", "Viktor:LWRB"],
            ["Viktor:LFIN", "Viktor:LWRB"],
            ["Viktor:LWRA", "Viktor:LWRB"],
        ]
        assert p._extended_interconnections["Viktor:RUpperLimb"]["Links"] == [
            ["Viktor:RELB", "Viktor:RSHO"],
            ["Viktor:RELB", "Viktor:RWRA"],
            ["Viktor:RFIN", "Viktor:RWRA"],
            ["Viktor:RELB", "Viktor:RWRB"],
            ["Viktor:RFIN", "Viktor:RWRB"],
            ["Viktor:RWRA", "Viktor:RWRB"],
        ]
        assert p._extended_interconnections["Viktor:Head"]["Links"] == [
            ["Viktor:C7", "Viktor:LFHD"],
            ["Viktor:LFHD", "Viktor:RFHD"],
            ["Viktor:C7", "Viktor:RFHD"],
            ["Viktor:C7", "Viktor:LBHD"],
            ["Viktor:LBHD", "Viktor:RBHD"],
            ["Viktor:C7", "Viktor:RBHD"],
            ["Viktor:LBHD", "Viktor:LFHD"],
            ["Viktor:RBHD", "Viktor:RFHD"],
        ]
        assert p._extended_interconnections["Viktor:TrunkPelvis"]["Links"] == [
            ["Viktor:LASI", "Viktor:STRN"],
            ["Viktor:RASI", "Viktor:STRN"],
            ["Viktor:CLAV", "Viktor:STRN"],
            ["Viktor:LPSI", "Viktor:T10"],
            ["Viktor:RPSI", "Viktor:T10"],
            ["Viktor:C7", "Viktor:T10"],
            ["Viktor:LASI", "Viktor:LSHO"],
            ["Viktor:LPSI", "Viktor:LSHO"],
            ["Viktor:RASI", "Viktor:RSHO"],
            ["Viktor:RPSI", "Viktor:RSHO"],
            ["Viktor:LASI", "Viktor:LPSI"],
            ["Viktor:LASI", "Viktor:RASI"],
            ["Viktor:RASI", "Viktor:RPSI"],
            ["Viktor:LPSI", "Viktor:RPSI"],
            ["Viktor:CLAV", "Viktor:LSHO"],
            ["Viktor:CLAV", "Viktor:RSHO"],
            ["Viktor:C7", "Viktor:RSHO"],
            ["Viktor:C7", "Viktor:LSHO"],
        ]
...
def test_interconnection_wildcards_as_suffix():
    ...
    try:
        assert p._extended_interconnections["_ViktorLLowerLimb"]["Links"] == [
            ["LHEE_Viktor", "LTOE_Viktor"],
            ["LANK_Viktor", "LHEE_Viktor"],
            ["LANK_Viktor", "LTOE_Viktor"],
            ["LANK_Viktor", "LKNE_Viktor"],
            ["LASI_Viktor", "LKNE_Viktor"],
            ["LKNE_Viktor", "LPSI_Viktor"],
        ]
        assert p._extended_interconnections["_ViktorRLowerLimb"]["Links"] == [
            ["RHEE_Viktor", "RTOE_Viktor"],
            ["RANK_Viktor", "RHEE_Viktor"],
            ["RANK_Viktor", "RTOE_Viktor"],
            ["RANK_Viktor", "RKNE_Viktor"],
            ["RASI_Viktor", "RKNE_Viktor"],
            ["RKNE_Viktor", "RPSI_Viktor"],
        ]
        assert p._extended_interconnections["_ViktorLUpperLimb"]["Links"] == [
            ["LELB_Viktor", "LSHO_Viktor"],
            ["LELB_Viktor", "LWRA_Viktor"],
            ["LFIN_Viktor", "LWRA_Viktor"],
            ["LELB_Viktor", "LWRB_Viktor"],
            ["LFIN_Viktor", "LWRB_Viktor"],
            ["LWRA_Viktor", "LWRB_Viktor"],
        ]
        assert p._extended_interconnections["_ViktorRUpperLimb"]["Links"] == [
            ["RELB_Viktor", "RSHO_Viktor"],
            ["RELB_Viktor", "RWRA_Viktor"],
            ["RFIN_Viktor", "RWRA_Viktor"],
            ["RELB_Viktor", "RWRB_Viktor"],
            ["RFIN_Viktor", "RWRB_Viktor"],
            ["RWRA_Viktor", "RWRB_Viktor"],
        ]
        assert p._extended_interconnections["_ViktorHead"]["Links"] == [
            ["C7_Viktor", "LFHD_Viktor"],
            ["LFHD_Viktor", "RFHD_Viktor"],
            ["C7_Viktor", "RFHD_Viktor"],
            ["C7_Viktor", "LBHD_Viktor"],
            ["LBHD_Viktor", "RBHD_Viktor"],
            ["C7_Viktor", "RBHD_Viktor"],
            ["LBHD_Viktor", "LFHD_Viktor"],
            ["RBHD_Viktor", "RFHD_Viktor"],
        ]
        assert p._extended_interconnections["_ViktorTrunkPelvis"]["Links"] == [
            ["LASI_Viktor", "STRN_Viktor"],
            ["RASI_Viktor", "STRN_Viktor"],
            ["CLAV_Viktor", "STRN_Viktor"],
            ["LPSI_Viktor", "T10_Viktor"],
            ["RPSI_Viktor", "T10_Viktor"],
            ["C7_Viktor", "T10_Viktor"],
            ["LASI_Viktor", "LSHO_Viktor"],
            ["LPSI_Viktor", "LSHO_Viktor"],
            ["RASI_Viktor", "RSHO_Viktor"],
            ["RPSI_Viktor", "RSHO_Viktor"],
            ["LASI_Viktor", "LPSI_Viktor"],
            ["LASI_Viktor", "RASI_Viktor"],
            ["RASI_Viktor", "RPSI_Viktor"],
            ["LPSI_Viktor", "RPSI_Viktor"],
            ["CLAV_Viktor", "LSHO_Viktor"],
            ["CLAV_Viktor", "RSHO_Viktor"],
            ["C7_Viktor", "RSHO_Viktor"],
            ["C7_Viktor", "LSHO_Viktor"],
        ]
        assert p._extended_interconnections["_DerrickLLowerLimb"]["Links"] == [
            ["LHEE_Derrick", "LTOE_Derrick"],
            ["LANK_Derrick", "LHEE_Derrick"],
            ["LANK_Derrick", "LTOE_Derrick"],
            ["LANK_Derrick", "LKNE_Derrick"],
            ["LASI_Derrick", "LKNE_Derrick"],
            ["LKNE_Derrick", "LPSI_Derrick"],
        ]
        assert p._extended_interconnections["_DerrickRLowerLimb"]["Links"] == [
            ["RHEE_Derrick", "RTOE_Derrick"],
            ["RANK_Derrick", "RHEE_Derrick"],
            ["RANK_Derrick", "RTOE_Derrick"],
            ["RANK_Derrick", "RKNE_Derrick"],
            ["RASI_Derrick", "RKNE_Derrick"],
            ["RKNE_Derrick", "RPSI_Derrick"],
        ]
        assert p._extended_interconnections["_DerrickLUpperLimb"]["Links"] == [
            ["LELB_Derrick", "LSHO_Derrick"],
            ["LELB_Derrick", "LWRA_Derrick"],
            ["LFIN_Derrick", "LWRA_Derrick"],
            ["LELB_Derrick", "LWRB_Derrick"],
            ["LFIN_Derrick", "LWRB_Derrick"],
            ["LWRA_Derrick", "LWRB_Derrick"],
        ]
        assert p._extended_interconnections["_DerrickRUpperLimb"]["Links"] == [
            ["RELB_Derrick", "RSHO_Derrick"],
            ["RELB_Derrick", "RWRA_Derrick"],
            ["RFIN_Derrick", "RWRA_Derrick"],
            ["RELB_Derrick", "RWRB_Derrick"],
            ["RFIN_Derrick", "RWRB_Derrick"],
            ["RWRA_Derrick", "RWRB_Derrick"],
        ]
        assert p._extended_interconnections["_DerrickHead"]["Links"] == [
            ["C7_Derrick", "LFHD_Derrick"],
            ["LFHD_Derrick", "RFHD_Derrick"],
            ["C7_Derrick", "RFHD_Derrick"],
            ["C7_Derrick", "LBHD_Derrick"],
            ["LBHD_Derrick", "RBHD_Derrick"],
            ["C7_Derrick", "RBHD_Derrick"],
        ...
        assert p._extended_interconnections["_DerrickTrunkPelvis"][
            ...
            ["LASI_Derrick", "STRN_Derrick"],
            ["RASI_Derrick", "STRN_Derrick"],
            ["CLAV_Derrick", "STRN_Derrick"],
            ["LPSI_Derrick", "T10_Derrick"],
            ["RPSI_Derrick", "T10_Derrick"],
            ["C7_Derrick", "T10_Derrick"],
            ["LASI_Derrick", "LSHO_Derrick"],
            ["LPSI_Derrick", "LSHO_Derrick"],
            ["RASI_Derrick", "RSHO_Derrick"],
            ["RPSI_Derrick", "RSHO_Derrick"],
            ["LASI_Derrick", "LPSI_Derrick"],
            ["LASI_Derrick", "RASI_Derrick"],
            ["RASI_Derrick", "RPSI_Derrick"],
            ["LPSI_Derrick", "RPSI_Derrick"],
            ["CLAV_Derrick", "LSHO_Derrick"],
            ["CLAV_Derrick", "RSHO_Derrick"],
            ["C7_Derrick", "RSHO_Derrick"],
            ["C7_Derrick", "LSHO_Derrick"],
        ]
