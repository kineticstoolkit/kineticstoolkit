...
def test_scripting():
    ...
    try:
        assert p._processed_interconnections["Derrick:LLowerLimb"][
            "Links"
        ] == [
        ...
        assert p._processed_interconnections["Derrick:RLowerLimb"][
            "Links"
        ] == [
        ...
        assert p._processed_interconnections["Derrick:LUpperLimb"][
            "Links"
        ] == [
        ...
        assert p._processed_interconnections["Derrick:RUpperLimb"][
            "Links"
        ] == [
        ...
        assert p._processed_interconnections["Derrick:Head"]["Links"] == [
        ...
        assert p._processed_interconnections["Derrick:TrunkPelvis"][
            "Links"
        ] == [
        ...
        assert p._processed_interconnections["Viktor:TrunkPelvis"][
            "Links"
        ] == [
...
def test_interconnection_wildcards_as_suffix():
    ...
    try:
        ...
        assert p._processed_interconnections["_ViktorTrunkPelvis"][
            "Links"
        ] == [
        ...
        assert p._processed_interconnections["_DerrickLLowerLimb"][
            "Links"
        ] == [
        ...
        assert p._processed_interconnections["_DerrickRLowerLimb"][
            "Links"
        ] == [
        ...
        assert p._processed_interconnections["_DerrickLUpperLimb"][
            "Links"
        ] == [
        ...
        assert p._processed_interconnections["_DerrickRUpperLimb"][
            "Links"
        ] == [
        ...
        assert p._processed_interconnections["_DerrickHead"]["Links"] == [
        ...
        assert p._processed_interconnections["_DerrickTrunkPelvis"][
            "Links"
        ] == [
