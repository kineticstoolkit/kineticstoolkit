...
def test_read_n3d_file():
    ...
    markers = ktk.kinematics.read_n3d_file(
        ...
        '/tutorials/data/kinematics/sample_optotrak.n3d')
    ...
    markers = ktk.kinematics.read_n3d_file(
        ktk.config.root_folder +
        '/tutorials/data/kinematics/sample_optotrak.n3d', labels=labels)
...
def test_read_c3d_file():
    ...
    markers = ktk.kinematics.read_c3d_file(
        ktk.config.root_folder +
        '/tutorials/data/kinematics/walkingOptiTrack.c3d')
