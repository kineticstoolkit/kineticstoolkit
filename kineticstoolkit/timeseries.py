...
class TimeSeries():
    ...
    def rename_event(self,
                     old_name: str,
                     new_name: str,
                     occurrence: Optional[int] = None) -> 'TimeSeries':
        """
    ...
    def resample(
            ...
            new_time: np.ndarray,
            kind: str = 'linear', *,
            fill_value: Union[np.ndarray, str, None] = None) -> 'TimeSeries':
        """
    ...
    def merge(self,
              ...
              data_keys: Union[str, List[str]] = [], *,
              resample: bool = False,
              overwrite: bool = True) -> 'TimeSeries':
        """
